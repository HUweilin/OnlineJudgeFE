<template>
  <el-menu class="vertical_menu"
    ...
    <el-submenu index="smallProblem">
      <template slot="title"><i class="el-icon-fa-list"></i>{{$t('m.Small_Problem')}}</template>
      <el-menu-item index="/small-problems">{{$t('m.Small_Problem_List')}}</el-menu-item>
      <el-menu-item index="/small-problem/create">{{$t('m.Create_Small_Problem')}}</el-menu-item>
      <el-menu-item index="/small-problem/batch_ops">{{$t('m.Export_Import_Problem')}}</el-menu-item>
    </el-submenu>
    ...
    <el-submenu index="course">
      <template slot="title"><i class="el-icon-fa-book"></i>{{$t('m.Course')}}</template>
      <el-menu-item index="/courses">{{$t('m.Course_List')}}</el-menu-item>
